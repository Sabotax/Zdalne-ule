...
const char* AP_SSID = "CGA2121_Tu7GnYu";  // your router's SSID here
const char* AP_PASS = "mtyRdz7KZcEc9k2Ezw";  // your router's password here
IPAddress staticIP(192, 168, 4, 1); // parameters below are for your static IP address, if used
